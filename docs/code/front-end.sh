...
cd counter-app
# cargo add app-utils --git "ssh://git@github.com/essential-contributions/essential-integration.git"
# cargo add app-utils --git "ssh://git@github.com/essential-contributions/essential-integration.git" --features test-utils --dev
